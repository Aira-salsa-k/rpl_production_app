// components/DeliveryDetailModal.jsx
...
export default function DeliveryDetailModal({ delivery, onClose, onConfirmDelivery }) {
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
                ...
                <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                    {delivery.customer_name || delivery.store_id?.name || 'External Customer'}
                    </span>
                </div>
            ...
            {(delivery.notes || delivery.delivery_address) && (
                <div>
                <h3 className="font-semibold text-gray-700 mb-2">
                    {delivery.notes ? 'Catatan' : 'Alamat Pengantaran'}
                </h3>
